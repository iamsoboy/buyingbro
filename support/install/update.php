...
<head>
        ...
        <title>HelpDesk 3 - Update Wizard</title>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-8 text">
                        <h1>HelpDesk 3 <strong>Update</strong> Wizard</h1>
                        <div class="description">
                            <p>
                                This will guide you through the update for HelpDesk 3. Make sure to follow the steps carefully.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-10 form-box">
                      <div class="f1">
                        ...
                        <p>Update your HelpDesk 3 to receive new features and fix some bugs.</p>
                        <div class="f1-steps">
                          ...
                          <h4>Install Database</h4>
                                ...
                                <div id="database_success" style="display: none">
                                  <div class="alert alert-success">
                                    <p>Batteries recharged! HD3 has been updated succesfully, please delete the <strong>install</strong> directory and login into your <a href="../<?php echo JAK_OPERATOR_LOC;?>/">operator</a> panel. Enjoy!!!</p>
                                  </div>
                                </div>
                                ...
                                <div id="license_failure" style="display: none">
                                  <div class="alert alert-danger">
                                    Uh oh, it looks like the boat has been stolen. Please <a href="https://www.jakweb.ch">contact us</a> and verify your purchase.
                                  </div>
                                </div>
                                <div class="f1-buttons">
                                    <button type="button" class="btn btn-previous">Previous</button>
