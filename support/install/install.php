...
if ($check_db && $jakdb && JAKDB_USER && JAKDB_PASS) {
  ...
  if (version_compare($mysqlv["version"], '5.5') < 0) {
    $result_mysqlv = '<strong style="color:red">You need a higher version of MySQL (min. MySQL 5.5)! MariaDB is fine!</strong>';
  } else {
...
if (version_compare($php_version, '5.6.0') < 0) {
  ...
  if (version_compare($php_version, '7.4.2') > 0) $php_big = '<br><strong style="color:red">The software has not been tested on your php version yet.</strong>';
...
<head>
        ...
        <title>HelpDesk 3 - Installation Wizard</title>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-8 text">
                        <h1>HelpDesk 3 <strong>Installation</strong> Wizard</h1>
                        <div class="description">
                            <p>
                                This will guide you through the installation for HelpDesk 3. Make sure to follow the steps carefully.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-10 form-box">
                      <div class="f1">
                        ...
                        <p>Install the most advanced HelpDesk solution on the market.</p>
                        <div class="f1-steps">
                          ...
                          <div class="f1-buttons">
                            ...
                            <fieldset>
                                <div id="form-success" style="display: none">
                                  <div class="alert alert-success">
                                    <p><h4>Welcome on board of HelpDesk 3</h4>HD3 has been installed succesfully, please delete the <strong>install</strong> directory and login into your <a href="../<?php echo JAK_OPERATOR_LOC;?>/">operator</a> panel. Enjoy!!!</p>
                                ...
                                <form action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" class="form-onboard">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" name="f1-envname" placeholder="Envato Usernname..." class="f1-envname form-control" id="f1-envname">
                                  </div>
                                  <div class="form-group">
                ...
                <footer>
  <p>Copyright 2020 by <a href="https://www.jakweb.ch">HelpDesk 3 - JAKWEB</a></p>
</footer>
