...
define('JAKDB_NAME', 'suppo_schema'); // Database name ## Datenbank Name
...
define('JAKDB_MAIN_NAME', 'suppo_schema'); // Database name ## Datenbank Name
