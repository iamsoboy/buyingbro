...
class DepositsController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        //Custom Code: To check if Deposit is already successful before changing the status
        if ($request->status == 1){
            $statusCheck = UserDeposit::where('id', $id)->first();
            ...
            $userWithdrawCase->user->userprofile->deposit_balance = $userWithdrawCase->user->userprofile->deposit_balance + $request->amount;
