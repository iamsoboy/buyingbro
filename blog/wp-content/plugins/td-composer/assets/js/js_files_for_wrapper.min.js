...
(function(f,d,b,e){tdcState={_headerTemplateId:"",_headerTemplateContent:"",_isGlobalTemplate:!1,_isNoHeader:!1,_isHeaderSticky:!1,_isMobileHeaderSticky:!1,_isGlobalFooterTemplate:!1,_isNoFooter:!1,init:function(a,c,b,e,m,d,h,k){tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(c);b&&tdcState.setGlobalTemplate();e&&tdcState.setNoHeader();tdcState.setFooterTemplateId(m);tdcState.setFooterTemplateContent(d);h&&tdcState.setGlobalFooterTemplate();k&&tdcState.setNoFooter()},setHeaderTemplateId:function(a){tdcState._headerTemplateId=
...
f=window.tdcPostSettings.headerTemplateId;d=window.tdcPostSettings.headerTemplateContent;var a=e=!1,c=window.tdcPostSettings.footerTemplateId,m=window.tdcPostSettings.footerTemplateContent,h=!1,k=!1;""===f?(f=window.tdcAdminSettings.headerTemplateId.toString().replace("tdb_template_",""),d=window.tdcAdminSettings.headerTemplateContent,e=!0):"no_header"===f&&(a=!0);if(""!==d){var l=JSON.parse(tdcUtil.b64DecodeUnicode(d));b.isUndefined(l.tdc_is_header_sticky)||!0!==l.tdc_is_header_sticky||tdcState.setHeaderSticky();
b.isUndefined(l.tdc_is_mobile_header_sticky)||!0!==l.tdc_is_mobile_header_sticky||tdcState.setMobileHeaderSticky()}""===c?(c=window.tdcAdminSettings.footerTemplateId.toString().replace("tdb_template_",""),m=window.tdcAdminSettings.footerTemplateContent,h=!0):"no_footer"===c&&(k=!0);tdcState.init(f,d,e,a,c,m,h,k)})(jQuery,Backbone,_);var tdcSavePost;
...
data:tdcLivePanel.$panel.serialize()}).done(function(a,e,d){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&(b.isObject(a)&&b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(new tdcNotice.notice("Content Successfully Saved!",!1,!0),0!==tdcLivePanel.$tdbPostSettings.length&&!0===tdcLivePanel.$tdbPostSettings.data("changed")&&new tdcNotice.notice("Single Templates Post Settings Successfully Saved!",
...
tdc_post_id:tdcLivePanel.$tdcPostId.val()}}).done(function(a,e,d){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&b.isObject(a)&&(b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(b.has(a,"header_template_id")&&(tdcState.setHeaderTemplateId(a.header_template_id),tdcSidebar.updateHeaderTemplates()),tdcMain.resetContentModified(),new tdcNotice.notice("Header Successfully Saved!",!1,!0)))}).fail(function(a,
...
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:d}).done(function(e,m,d){"success"===m&&b.isObject(e)&&(b.has(e,"errors")?new tdcNotice.notice(e.errors,!0,!1):b.has(e,"footer_template_id")&&(tdcState.setFooterTemplateId(e.footer_template_id),tdcState.unsetGlobalFooterTemplate()),tdcSidebar.updateFooterTemplates(),tdcIFrameData.setFooterTemplate(a,c))}).fail(function(a,c,b){}))},getFooterTemplateData:function(){var a=
...
(c.preventDefault(),tdcOperationUI.setCurrentElementOver(e),tdcColumnUI.positionColumnPlaceholder(c)):(tdcMaskUI.setCurrentContainer(e),c=tdcOperationUI.inRow(a),b.isUndefined(c)||c.mouseenter())}).on("fakemouseenterevent",function(c){if(tdcOperationUI.isColumnDragged(a)){var b=a.find(".tdc-elements:first");if(b.length){var e=b.outerHeight(!0);b=b.outerWidth();var d=a.offset(),l=0,g=a.prevAll("."+tdcColumnUI._elementCssClass);g.length&&g.each(function(a,c){l+=parseInt(f(c).find(".tdc-elements:first").width())});
...
positionColumnPlaceholder:function(a,c){var d=tdcAdminWrapperUI.$placeholder,h=0,k=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)h=a.pageX,k=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){h=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;k=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var l={pageX:h,pageY:k};
tdcOperationUI.setCurrentElementOver(e);tdcOperationUI.getDraggedElement().closest(".tdc-columns").find(".tdc-column").each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",l))});return}a=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(a))tdcOperationUI.hidePlaceholder();else{var g=a.outerWidth(!0);k=tdcOperationUI.getCurrentElementOverOffset();var n=0,p=a.prevAll();p.length&&
p.each(function(a,c){a=f(c);a.hasClass("tdc-column")&&(n+=parseInt(a.outerWidth(!0)))});p=a.parent(".tdc-columns").parent(".vc_row");var q=p.css("position");if(b.isUndefined(q)||"static"!==q)if(p=p.css("padding-left"),b.isUndefined(p)||(p=parseInt(p.replace("px",""))),h>k.left+g/2){h=a.next();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)a.after(d),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+g+p),"margin-left":-24,top:""})}else{h=
a.prev();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)a.before(d),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+p),"margin-left":-24,top:""})}else if(h>k.left+g/2){h=a.next();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)a.after(d),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(k.left+g),"margin-left":-24,top:""})}else{h=a.prev();if(!h.length||h.length&&h.attr("id")!==
tdcAdminWrapperUI.placeholderId)a.before(d),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(k.left),"margin-left":-24,top:""})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcColumnUI._elementCssClass}}})(jQuery,Backbone,_);var tdcInnerRowUI;
...
tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;k=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var l={pageX:h,pageY:k};tdcOperationUI.setCurrentElementOver(e);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",l))});tdcInnerRowUI.tdcElementInnerRow.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",
l))});return}a=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(a))tdcOperationUI.hidePlaceholder();else{var g=a.outerHeight(!0);h=a.innerWidth();var n=a.offset();if(k>n.top+g/2){k=a.next();if(!k.length||k.length&&k.attr("id")!==tdcAdminWrapperUI.placeholderId)a.after(d),tdcOperationUI.updateInfoHelper(e);parseInt(n.top)+parseInt(g)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",
top:"",left:"","margin-top":"","margin-left":"",bottom:"0",width:h}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:h})}else{k=a.prev();if(!k.length||k.length&&k.attr("id")!==tdcAdminWrapperUI.placeholderId)a.before(d),tdcOperationUI.updateInfoHelper(e);parseInt(n.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:"","margin-top":"0","margin-left":"",
...
(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){d.X=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;d.Y=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var h={pageX:d.X,pageY:d.Y};tdcOperationUI.setCurrentElementOver(e);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",h))});return}var k=tdcOperationUI.getCurrentElementOver();
if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(k))tdcOperationUI.hidePlaceholder();else{var l=tdcOperationUI.getCurrentElementOverOuterHeight();a=tdcOperationUI.getCurrentElementOverOuterWidth();var g=tdcOperationUI.getCurrentElementOverOffset(),n=tdcOperationUI.getCurrentElementOverHeight(),p=!1;"inline-block"===k.css("display")&&(p=!0);p?(l=tdcOperationUI.getCurrentElementOverPosition(),p=parseInt(k.css("margin-top")),d.Y>g.top+n/2?(d=tdcElementUI._checkInnerColumnLastElement(d),
b.isUndefined(d.elementOuterWidth)||(a=d.elementOuterWidth),parseInt(g.top)+parseInt(n)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?(g=parseInt(g.left),d.isInnerColumnLastElement&&(k=k.closest(".tdc-element-inner-row"),g=parseInt(k.offset().left)-parseInt(k.css("margin-left"))),tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:g,"margin-top":"","margin-left":"",bottom:"0",width:a})):(g=parseInt(l.left),d.isInnerColumnLastElement&&(k=k.closest(".tdc-element-inner-row"),
g=parseInt(k.position().left)+parseInt(k.css("margin-left"))),tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:l.top+p+n,left:g,"margin-top":"","margin-left":"",bottom:"",width:a}))):(d=tdcElementUI._checkInnerColumnFirstElement(d),b.isUndefined(d.elementOuterWidth)||(a=d.elementOuterWidth),parseInt(g.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?(g=parseInt(g.left)-parseInt(k.css("margin-left")),tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:g,"margin-top":"0",
"margin-left":"",bottom:"",width:a})):(g=parseInt(l.left),tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:l.top+p,left:g,"margin-top":"","margin-left":"",bottom:"",width:a})))):d.Y>g.top+n/2?(d=tdcElementUI._checkInnerColumnLastElement(d),b.isUndefined(d.elementOuterWidth)||(a=d.elementOuterWidth),parseInt(g.top)+parseInt(l)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"",
...
if(h>d.top+g/2){var n=!1;tdcElementUI.isInnerColumnLastElement(l)&&h>d.top+g-tdcElementUI._innerColumnGap&&(n=!0);n?(l=l.closest(".tdc-element-inner-row"),a=l.outerWidth(!0),h=l.next(),h.length||(l.after(c),tdcOperationUI.updateInfoHelper(e))):(h=l.next(),h.length||(l.after(c),tdcOperationUI.updateInfoHelper(e)));parseInt(d.top)+parseInt(g)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"",
"margin-left":"",bottom:0,width:a}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":-50,"margin-left":"",bottom:"",width:a})}else g=!1,tdcElementUI.isInnerColumnFirstElement(l)&&h<d.top+tdcElementUI._innerColumnGap&&(g=!0),g?(l=l.closest(".tdc-element-inner-row"),a=l.outerWidth(!0),h=l.prev(),h.length||(l.before(c),tdcOperationUI.updateInfoHelper(e))):(h=l.prev(),h.length||(l.before(c),tdcOperationUI.updateInfoHelper(e))),parseInt(d.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?
...
!0,!1);else{a=tdcIFrameData.getModel(a);var c=a.get("parentModel"),d=c.get("childCollection");if(b.isUndefined(a))new tdcNotice.notice("tdcRowHandlerUI -> tdcRowHandlerUI._$handlerClone Error: Element model not in structure data!",!0,!1);else{tdcOperationUI.setDraggedElement(f('<div class="tdc-row">Cloned row</div>'));var k=tdcOperationUI.getDraggedElement();k.insertAfter(tdcRowHandlerUI.$elementRow);tdcRowUI.bindRow(k);var l=k.prevAll(".tdc-row").length;c=new tdcIFrameData.TdcModel({content:"",attrs:b.clone(a.get("attrs")),
tag:"vc_row",type:"closed",level:1,parentModel:c});new tdcIFrameData.TdcLiveView({model:c,el:k[0]});var g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:c});k.data("model_id",c.cid);d.add(c,{at:l});d=new tdcIFrameData.TdcCollection;d.add(g);c.set("childCollection",d);g.set("childCollection",new tdcIFrameData.TdcCollection);c.getShortcodeRender(3,"",!0,a);tdcOperationUI.setDraggedElement(e);tb_remove()}}},[a],"Are you sure you want to clone the current row and all its elements?"),
...
!0,!1);else{tdcOperationUI.setDraggedElement(f('<div class="tdc-element-column tdc-element-inner-row">Cloned Inner Row</div>'));var c=tdcOperationUI.getDraggedElement();c.insertAfter(tdcInnerRowHandlerUI.$elementInnerRow);tdcInnerRowUI.bindInnerRow(c);var d=c.prevAll(".tdc-element-column").length,k=new tdcIFrameData.TdcModel({content:"",attrs:b.clone(a.get("attrs")),tag:"vc_row_inner",type:"closed",level:2,parentModel:a.get("parentModel")});new tdcIFrameData.TdcLiveView({model:k,el:c[0]});var l=new tdcIFrameData.TdcModel({content:"",
attrs:{},tag:"vc_column_inner",type:"closed",level:3,parentModel:k});c.data("model_id",k.cid);a.get("parentModel").get("childCollection").add(k,{at:d});c=new tdcIFrameData.TdcCollection;c.add(l);k.set("childCollection",c);c=new tdcIFrameData.TdcCollection;l.set("childCollection",c);l=tdcIFrameData._getDestinationCol(tdcOperationUI.getDraggedElement());k.getShortcodeRender(l,"",!0,a);tdcOperationUI.setDraggedElement(e);tb_remove()}},[a],"Are you sure you want to clone the current inner row and all its elements?")},
...
f(this);if(h.data("type")===a){var m=h.data("model_id");if(!b.isUndefined(m)&&(m=tdcIFrameData.getModel(m),!b.isUndefined(m))){var l=m.get("blockUid");if(!b.isUndefined(l)){var g=tdcAdminIFrameUI.getLiveIframe(),n=g.contents().find("#"+l);n.length||(n=g.contents().find('[data-td-block-uid="'+l+'"]'));n.length&&(l={},tdcOperationUI.inRow(n)?tdcOperationUI.inRow(n)?tdcOperationUI.inColumn(n)?tdcOperationUI.inInnerRow(n)?tdcOperationUI.inInnerColumn(n)?(l.$currentZone=tdcOperationUI.inZone(n),l.$currentRow=
...
l.$currentInnerRow=n):(l.$currentZone=tdcOperationUI.inZone(n),l.$currentRow=tdcOperationUI.inRow(n),l.$currentColumn=n):(l.$currentZone=tdcOperationUI.inZone(n),l.$currentRow=n):l.$currentZone=n,tdcSidebar._currentModel=m,n.data("model_id",m.cid),tdcSidebar.setSettings(l,!0,m),tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-phone").trigger("click"),0<a.indexOf("sticky")?(0<a.indexOf("mobile")?tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-phone").trigger("click"):
...
c,d,h){var m=tdcIFrameData.getFirstModelByZoneType(a);if(!b.isUndefined(m)){var l=m.get("blockUid");tdcIFrameData.removeModel(m,!0,{silent:!0});m=tdcIFrameData._getOriginalContentJSON(c);if(b.isUndefined(m)||""===m)m=[{child:[tdcShortcodeParser.parse(0,'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]')[0].child[0]],index:0,content:'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]',shortcode:{tag:"tdc_zone",type:"closed",attrs:{named:{type:a}},content:"[vc_row][vc_column][/vc_column][/vc_row]"}}];
if(tdcIFrameData._initComponentData(a,m,!0)){m=tdcIFrameData.getFirstModelByZoneType(a);a=tdcIFrameData.iframeContents.find("#"+l);if(!a.length)return!1;c=a.get(0);a.data("model_id",m.cid);m.set("blockUid",l);m.set("html",c.innerHTML);new tdcIFrameData.TdcLiveView({model:m,el:c});b.isUndefined(d)||tdcIFrameData._checkModelData(m,{error:e,getShortcode:"",newImages:d});m.getShortcodeRender(3,l,!0,e,h)}return!0}return!1},setHeaderTemplate:function(a,c,d){if(""===a)tdcState.isNoHeader()?tdcIFrameData.iframeContents.find(".tdc-header-wrap").addClass("tdc-zone-invisible"):
...
setTimeout(function(){a.lateCallback.call(this)},2E3):setTimeout(function(){a.lateCallback.call(a.lateCallbackContext)},2E3))},_defineStructuredData:function(){tdcIFrameData._isInitialized||(tdcIFrameData.TdcModel=Backbone.Model.extend({getShortcodeRender:function(a,c,d,h,k){var m=this,g={error:e,getShortcode:""};b.isUndefined(h)?tdcIFrameData._checkModelData(m,g):tdcIFrameData._checkModelData(h,g);if(!b.isUndefined(g.getShortcode)){var f=new tdcJobManager.job;f.shortcode=g.getShortcode;f.columns=
a;f.blockUid=c;f.tries=0;f.success_callback=function(a){tdcDebug.log(a);var l=tdcAdminIFrameUI.getIframeWindow();b.isUndefined(h)&&tdcIFrameData.deleteCallback(m);!1===d?m.set("blockUid",a.blockUid):m.set("blockUid",e);b.has(a,"replyHtml")&&(m.set("bindNewContent",d),m.set("shortcode",f.shortcode),m.set("html",a.replyHtml,k));b.has(a,"replyJsForEval")&&(l.tdcEvalGlobal={oldBlockUid:c},tdcAdminIFrameUI.evalInIframe(a.replyJsForEval));b.isUndefined(k)||b.isUndefined(k.earlyCallback)||(b.isUndefined(k.earlyCallbackContext)?
k.earlyCallback.call(this):k.earlyCallback.call(k.earlyCallbackContext))};b.isUndefined(k)||b.isUndefined(k.is_snapshot)||!0!==k.is_snapshot||(f.is_snapshot=!0);f.error_callback=function(a,c){tdcDebug.log(c);tdcDebug.log(a);f.tries||(f.tries++,tdcJobManager.addJob(f))};a=tdcOperationUI.getDraggedElement();b.isUndefined(a)||a.addClass("tdc-dropped");tdcJobManager.addJob(f)}g={error:e,getShortcode:""};tdcIFrameData._checkModelData(m,g);b.isUndefined(g.error)||tdcDebug.log(g.error);g={error:e,getShortcode:""};
...
!0,!1);return}a=tdcIFrameData.getFirstModelByZoneType("tdc_content");b.isUndefined(a)&&new tdcNotice.notice("Errors happened in templateContent during tdc_content zone!",!0,!1);l=a.get("childCollection");b.isUndefined(l)&&new tdcNotice.notice("Errors happened in templateContent during tdc_content childCollection!",!0,!1);l=new tdcIFrameData.TdcCollection;a.set("childCollection",l);g={};b.each(c,function(c,b,e){tdcIFrameData._getData(a,c,g)});b.isEmpty(g)||(tdcDebug.log(g),new tdcNotice.notice("Errors happened in templateContent during tdcIFrameData.changeData() -> _getData()!",
!0,!1));c={error:e,shortcode:e};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice(g,!0,!1));l=a.get("childCollection");if(n.length!==l.length){new tdcNotice.notice("Errors happened in templateContent during() tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}q.$el.find(".tdc-row").each(function(a,c){var e=f(c);e.insertBefore(q.$el);a=l.at(a);new tdcIFrameData.TdcLiveView({model:a,el:c});var d=q.$el.prevAll().length;c=a.get("childCollection");
l.add(a,{at:d});window.addRowWrappers(e);if(!0===tdcIFrameData._initNewContentStructureData(2,p,a)&&!b.isUndefined(c))if(d={},tdcIFrameData.bindViewsModelsWrappers(d,c,e,2),b.isEmpty(d))e.data("model_id",a.cid);else{for(var m in d)tdcDebug.log(d[m]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1)}});a.set("childCollection",l);n=tdcOperationUI.inZone(q.$el);q.$el.remove();tdcIFrameData.removeModel(q.model);tdcZoneUI.init(m);tdcRowUI.init(m);tdcColumnUI.init(m);
tdcInnerRowUI.init(m);tdcInnerColumnUI.init(m);tdcElementUI.init(m);tdcSidebar.setSettings({$currentZone:n,$currentRow:m},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}}else if(this.$el.hasClass("tdc-row-temp")){if(a.has("templateContent")){c=tdcUtil.b64DecodeUnicode(a.get("templateContent"));m=this.$el.find(".tdc-row");l=a.get("childCollection");a.set("type","closed");a.set("content",c);a.unset("shortcode",{silent:!0});a.unset("templateContent",{silent:!0});tdcShortcodeParser.init(tdcIFrameData._shortcodeParserSettingsClone);
k=tdcShortcodeParser.parse(1,c);k.length&&(k=b.clone(k[0].shortcode.attrs.named),a.set("attrs",k));this.$el.removeClass("tdc-row-temp").addClass(m.attr("class"));this.$el.attr("id",m.attr("id"));this.$el.html(m.html());this.model.set("blockUid",m.attr("id"));window.addRowWrappers(this.$el);if(!0===tdcIFrameData._initNewContentStructureData(2,c,a)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,l,this.$el,2),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}tdcRowUI.init(this.$el.parent());tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:this.$el},e,this.model)}else{m=this.$el.find(".tdc-row");l=a.get("childCollection");this.$el.removeClass("tdc-row-temp").addClass(m.attr("class"));this.$el.attr("id",m.attr("id"));this.$el.html(m.html());this.model.set("blockUid",m.attr("id"));window.addRowWrappers(this.$el);g={};tdcIFrameData.bindViewsModelsWrappers(g,
...
l=this.model.get("childCollection");b.isUndefined(l)||l.reset();this.$el.html(m.html());this.$el.attr("class",m.attr("class"));this.$el.attr("id",m.attr("id"));this.model.set("blockUid",m.attr("id"));window.addZoneWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(1,p,this.model)&&!b.isUndefined(l)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,l,this.$el,1),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
...
window.addRowWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(2,p,this.model)&&!b.isUndefined(l)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,l,this.$el,2),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),
$currentRow:this.$el},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-column")){a.has("templateContent")&&(c=tdcUtil.b64DecodeUnicode(a.get("templateContent")),a.set("type","closed"),a.unset("templateContent",{silent:!0}));m=this.$el.find(".tdc-column");l=this.model.get("childCollection");b.isUndefined(l)||l.reset();m.unwrap();this.$el=m;this.$el.data("model_id",this.model.cid);window.addColumnWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(3,
p,this.model)&&(l=this.model.get("childCollection"),!b.isUndefined(l)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,l,this.$el,3),!b.isEmpty(g)))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcColumnUI.init(this.$el.parent());tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:tdcOperationUI.inRow(this.$el),
$currentColumn:this.$el},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-inner-row")){m=this.$el.find(".tdc-inner-row");l=this.model.get("childCollection");b.isUndefined(l)||l.reset();this.$el.html(m.html());window.addInnerRowWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(3,p,this.model)&&!b.isUndefined(l)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,l,this.$el,3),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);
...
a.set("type","closed"),a.unset("templateContent",{silent:!0}));m=this.$el.find(".tdc-inner-column");l=this.model.get("childCollection");b.isUndefined(l)||l.reset();m.unwrap();this.$el=m;this.$el.data("model_id",this.model.cid);window.addInnerColumnWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(5,p,this.model)&&(l=this.model.get("childCollection"),!b.isUndefined(l)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,l,this.$el,5),!b.isEmpty(g)))){for(n in g)tdcDebug.log(g[n]);
new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcInnerColumnUI.init(this.$el.parent());tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:tdcOperationUI.inInnerRow(this.$el),$currentInnerColumn:this.$el},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc_zone")){m=
this.$el.find(".tdc-row");c=this.model.cid;a=tdcIFrameData.getModel(c);l=a.get("childCollection");m.data("model_id",c);this.model.set("blockUid",m.attr("id"));window.addZoneWrappers(this.$el);if(!b.isUndefined(l)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,l,m,2),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcZoneUI.init(this.$el);tdcRowUI.init(this.$el);tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);
...
!0,!1))}return!0},_getData:function(a,c,e,d,k){var m;if(b.isUndefined(a))var h=tdcIFrameData.tdcTopCollection;else h=a.get("childCollection"),b.isUndefined(h)&&(h=new tdcIFrameData.TdcCollection,a.set("childCollection",h));for(var f in tdcIFrameData._shortcodeParserSettingsClone)if(!(!b.isUndefined(d)&&parseInt(d,10)>f||b.isUndefined(c.shortcode))&&b.isObject(c.shortcode)&&b.has(c.shortcode,"tag")&&-1!==b.indexOf(tdcIFrameData._shortcodeParserSettingsClone[f],c.shortcode.tag)){0<parseInt(f,10)&&b.isUndefined(a)&&
...
c)});b.isUndefined(c.getShortcode)||c.deepLevel--}if(!b.isUndefined(c.getShortcode)){d=a.get("type");var k=a.get("tag"),l=a.get("attrs"),g="";if("undefined"!==typeof c.images){var f=b.clone(l);b.map(l,function(a,e){b.map(window.tdcAdminSettings.mappedShortcodes[k].params,function(a,d){if(e===a.param_name)if("attach_image"===a.type)a=l[a.param_name],d=tdcJobManager._getUniqueID(),b.isUndefined(c.images.ids)?(c.images.ids={},c.images.ids[a]=d):b.isUndefined(c.images.ids[a])?c.images.ids[a]=d:d=c.images.ids[a],
f[e]=d;else if("tdc_css"===a.param_name&&""!==l.tdc_css){var m=JSON.parse(window.atob(l.tdc_css));b.map(m,function(a,e){b.map(m[e],function(a,d){if(0===a.trim().indexOf("url")){var h=tdcJobManager._getUniqueID();b.isUndefined(c.images.urls)?(c.images.urls={},c.images.urls[a]=h):b.isUndefined(c.images.urls[a])?c.images.urls[a]=h:h=c.images.urls[a];m[e][d]=h}})});f.tdc_css=window.btoa(JSON.stringify(m))}})});l=f}else"undefined"!==typeof c.newImages&&(f=b.clone(l),b.map(l,function(a,e){b.map(window.tdcAdminSettings.mappedShortcodes[k].params,
function(a,d){if(e===a.param_name)if("attach_image"===a.type){var m=l[a.param_name];a=c.newImages.find(function(a){return m===a.uid.substring(8)});"undefined"!==typeof a&&(f[e]=a.attachment_id)}else if("tdc_css"===a.param_name&&""!==l.tdc_css){var h=JSON.parse(window.atob(l.tdc_css));b.map(h,function(a,e){b.map(h[e],function(a,b){var d=c.newImages.find(function(c){return a===c.uid.substring(8)});"undefined"!==typeof d&&(h[e][b]='url("'+d.url+'")')})});f.tdc_css=window.btoa(JSON.stringify(h))}})}),
l=f,a.set("attrs",l));if("td_block_text_with_title"===k||"vc_column_text"===k||"vc_raw_html"===k||"tdc_woo_shortcodes"===k)if(b.map(l,function(a,c){"content"!==c&&(g+=" "+c+'="'+a+'"')}),b.has(l,"content"))if("vc_raw_html"===k||"tdc_woo_shortcodes"===k)g="["+k+g+"]"+b.unescape(l.content)+"[/"+k+"]";else try{var p=tdcUtil.b64DecodeUnicode(l.content);g="["+k+g+"]"+p+"[/"+k+"]"}catch(q){g="["+k+g+"]"+b.unescape(l.content)+"[/"+k+"]"}else g="["+k+g+"][/"+k+"]";else switch(b.map(l,function(a,c){g+=" "+
c+'="'+a+'"'}),d){case "single":g="["+k+g+"]";break;case "closed":a="";b.isUndefined(c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)])||(a=c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)],c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)]=e);g="["+k+g+"]"+a+"[/"+k+"]";break;case "template":g="vc_column"===k||"vc_column_inner"===k?"["+k+g+"]"+c.template+"[/"+k+"]":c.template}c["tempShortcodeDeepLevel"+c.deepLevel]+=g;0===c.deepLevel&&(c.getShortcode+=g)}}else c.error="Not zones as the first elements!"}},
...
!0,!1);var k=tdcIFrameData._getDestinationCol(a.$refEl);h.has("childCollection")||h.set("childCollection",new tdcIFrameData.TdcCollection);var l=h.get("childCollection");var g={},f=c.data("start-values"),p;"undefined"!==typeof f&&(f=JSON.parse(tdcUtil.b64DecodeUnicode(f)),"undefined"!==typeof f&&(b.isArray(f)&&f.length?(g=f[0],1<f.length&&(p=f)):g=f));f=c.data("shortcodeName");g=new tdcIFrameData.TdcModel({content:"",attrs:g,tag:f,type:"single",level:4,parentModel:h});new tdcIFrameData.TdcLiveView({model:g,
el:c[0]});b.isUndefined(p)||g.set("presetValues",p);tdcElementUI.bindElement(c);tdcRecycle.takeSnapshot(g.get("tag")+" : sidebar element added");c.data("model_id",g.cid);l.add(g,{at:d});g.set("parentModel",h);g.getShortcodeRender(k,a.draggedBlockUid,!0)}else if(a.wasTempInnerRowDragged)tdcRecycle.takeSnapshot("Sidebar inner-row added"),h=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]),b.isUndefined(h)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",
!0,!1),k=tdcIFrameData._getDestinationCol(a.$refEl),h.has("childCollection")||h.set("childCollection",new tdcIFrameData.TdcCollection),l=h.get("childCollection"),f=c.data("templateContent"),b.isUndefined(f)?(h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row_inner",type:"closed",level:3,parentModel:h}),new tdcIFrameData.TdcLiveView({model:h,el:c[0]}),g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:4,parentModel:h}),c.data("model_id",h.cid),l.add(h,
{at:d}),c=new tdcIFrameData.TdcCollection,c.add(g),h.set("childCollection",c),c=new tdcIFrameData.TdcCollection,g.set("childCollection",c)):(h=new tdcIFrameData.TdcModel({templateContent:f,attrs:{},tag:"vc_row_inner",type:"template",level:3,parentModel:h}),new tdcIFrameData.TdcLiveView({model:h,el:c[0]}),c.data("model_id",h.cid),l.add(h,{at:d})),h.getShortcodeRender(k,a.draggedBlockUid,!0);else if(a.wasTempRowDragged){tdcRecycle.takeSnapshot("Sidebar row added");f=c.data("templateContent");h=tdcIFrameData._getDestinationModel(a.$refEl,
[".tdc-zone"]);b.isUndefined(h)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);h.has("childCollection")||h.set("childCollection",new tdcIFrameData.TdcCollection);l=h.get("childCollection");if(b.isUndefined(f)){var q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:h});new tdcIFrameData.TdcLiveView({model:q,el:c[0]});g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q});
c.data("model_id",q.cid);d=c.prevAll(".tdc-row").length;l.add(q,{at:d});l=new tdcIFrameData.TdcCollection;l.add(g);q.set("childCollection",l);d=new tdcIFrameData.TdcCollection;g.set("childCollection",d);a.wasElementWithRowDragged&&(l={},h={},f=c.data("start-values"),k=c.data("row-start-values"),"undefined"!==typeof k&&(h=JSON.parse(window.atob(k))),q.set({attrs:h}),"undefined"!==typeof f&&(l=JSON.parse(window.atob(f)),b.isArray(l)&&(l=l[0])),f=c.data("shortcodeName"),c=new tdcIFrameData.TdcModel({content:"",
attrs:l,tag:f,type:"single",level:3,parentModel:g}),d.add(c),g=new tdcIFrameData.TdcCollection,c.set("childCollection",g))}else q=new tdcIFrameData.TdcModel({templateContent:f,attrs:{},tag:"vc_row",type:"template",level:1,parentModel:h}),new tdcIFrameData.TdcLiveView({model:q,el:c[0]}),d=c.prevAll(".tdc-row").length,c.data("model_id",q.cid),b.isUndefined(h)||(l.add(q,{at:d}),h.set("childCollection",l),q.set("childCollection",new tdcIFrameData.TdcCollection));q.getShortcodeRender(1,a.draggedBlockUid,
!0)}else if(a.wasColumnDragged){if(tdcRecycle.takeSnapshot("Column copied"),f=c.data("templateContent"),!b.isUndefined(f)){c=c.data("model_id");if(b.isUndefined(c)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}g=tdcIFrameData.getModel(c);if(b.isUndefined(g)){new tdcNotice.notice("changeData Error: Column model not in structure data!",!0,!1);return}g.set("templateContent",f);g.set("type","template");k=tdcIFrameData._getDestinationCol(a.$refEl);g.getShortcodeRender(k,
...
tdcRecycle.takeSnapshot(g.get("tag")+" : element recycled");return}tdcRecycle.takeSnapshot(g.get("tag")+" : element moved");p=g.get("parentModel");h=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-inner-column",".tdc-column"]);b.isUndefined(h)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);p.cid===h.cid?(k=p.get("childCollection"),k.remove(g,{silent:!0}),k.add(g,{at:d})):(k=tdcIFrameData._getDestinationCol(a.$refEl),h.has("childCollection")||h.set("childCollection",
new tdcIFrameData.TdcCollection),l=h.get("childCollection"),tdcIFrameData.removeModel(g,!1,{silent:!0}),l.add(g,{at:d}),g.set("parentModel",h),a.sourceColParam!==k&&g.getShortcodeRender(k,a.draggedBlockUid,!0));tdcRecycle.takeSnapshot(g.get("tag")+" : element moved")}else if(a.wasInnerRowDragged){tdcDebug.log("case 2");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("inner row recycled");tdcIFrameData.removeModel(g);tdcRecycle.takeSnapshot("Inner row recycled");
return}tdcRecycle.takeSnapshot("Inner row moved");p=g.get("parentModel");h=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]);b.isUndefined(h)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);if(p.cid===h.cid)k=p.get("childCollection"),k.remove(g,{silent:!0}),k.add(g,{at:d});else{h.has("childCollection")||h.set("childCollection",new tdcIFrameData.TdcCollection);l=h.get("childCollection");tdcIFrameData.removeModel(g,!0,{silent:!0});l.add(g,{at:d});
g.set("parentModel",h);a=p.get("attrs");d=h.get("attrs");if(b.has(a,"width"))switch(a.width){case "1/3":k="13";break;case "2/3":k="23"}if(b.has(d,"width"))switch(d.width){case "1/3":f="13";break;case "2/3":f="23"}b.isUndefined(k)&&(k="11");b.isUndefined(f)&&(f="11");if(k!==f&&(a=g.get("childCollection"),!b.isUndefined(a))){a=tdcIFrameData.getChildCollectionWidths(a);b.isUndefined(a)&&(a="11");d="11";l=1;switch(f){case "11":switch(a){case "11":d="11";break;case "23_13":d="23_13";break;case "13_23":d=
"13_23";break;case "12_12":d="13_13_13";break;case "13_13_13":d="13_13_13"}l=3;break;case "13":switch(a){case "11":d="11";break;case "23_13":d="11";break;case "13_23":d="11";break;case "12_12":d="11";break;case "13_13_13":d="11"}break;case "23":switch(a){case "11":d="12_12";break;case "23_13":d="12_12";break;case "13_23":d="12_12";break;case "12_12":d="12_12";break;case "13_13_13":d="12_12"}l=2}if(a!==d||k!==f)tdcIFrameData.changeInnerRowModel(g,a,d),g.getShortcodeRender(l,null,!0)}a=tdcOperationUI.inZone(c);
d=tdcOperationUI.inRow(c);l=tdcOperationUI.inColumn(c);c=tdcOperationUI.inInnerRow(c);b.isUndefined(a)||b.isUndefined(d)||b.isUndefined(l)||b.isUndefined(c)||tdcSidebar.setSettings({$currentZone:a,$currentRow:d,$currentColumn:l,$currentInnerRow:c},!0)}tdcRecycle.takeSnapshot(g.get("tag")+" : inner row moved")}else if(a.wasInnerColumnDragged||a.wasColumnDragged)tdcDebug.log("case 3"),p=g.get("parentModel"),k=p.get("childCollection"),k.remove(g,{silent:!0}),k.add(g,{at:d}),a.wasColumnDragged?(a=tdcOperationUI.inZone(c),
...
else if(a.wasRowDragged){tdcDebug.log("case 4");p=g.get("parentModel");f=p.get("blockUid");k=p.get("childCollection");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){k.remove(g);tdcDebug.log("row recycled");tdcRecycle.takeSnapshot("Row recycled");k.length||(q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:p}),new tdcIFrameData.TdcLiveView({model:q,el:tdcIFrameData.iframeContents.find("#"+f+" .tdc_zone")[0]}),g=new tdcIFrameData.TdcModel({content:"",
attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q}),k.add(q,{at:0}),l=new tdcIFrameData.TdcCollection,l.add(g),q.set("childCollection",l),g.set("childCollection",new tdcIFrameData.TdcCollection),q.getShortcodeRender(1,a.draggedBlockUid,!0));return}d=c.prevAll(".tdc-row").length;a=c.closest(".tdc-zone").data("model_id");l=k;p.cid!==a&&(h=tdcIFrameData.getModel(a),l=h.get("childCollection"));k.remove(g,{silent:!0});l.add(g,{at:d});h.set("childCollection",l);g.set("parentModel",h);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(c)});
k.length||(q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:p}),new tdcIFrameData.TdcLiveView({model:q,el:tdcIFrameData.iframeContents.find("#"+f+" .tdc_zone")[0]}),g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q}),k.add(q,{at:0}),l=new tdcIFrameData.TdcCollection,l.add(g),q.set("childCollection",l),g.set("childCollection",new tdcIFrameData.TdcCollection),setTimeout(function(){q.getShortcodeRender(1,
e,!0)},200));p.set("childCollection",k);tdcRecycle.takeSnapshot("Row moved");tdcDebug.log("newPosition: "+d);tdcDebug.log(c)}}tdcDebug.log(tdcIFrameData.tdcTopCollection)}},_parseModelWidthAttrs:function(a){a=a.get("attrs");var c=3;if(b.has(a,"width"))switch(a.width){case "1/3":c=1;break;case "2/3":c=2;break;case "1/2":c=1}return c},getColumnNumber:function(a){var c=3,e=parseInt(a.get("level"),10),d=a.get("parentModel");b.isUndefined(d)||(4===e?(a=tdcIFrameData._parseModelWidthAttrs(d),c=3===a?tdcIFrameData.getColumnNumber(d):
...
"(models) : "+m.length+"(dom)",level:d};return}break;case 5:if(e.find(".tdc-elements:first").children(".tdc-element").each(function(){var a=f(this);a.parents(".menu-item").length||m.push(a)}),c.models.length!==m.length){a[b.keys(a).length]={collection:c,jqDOMElements:m,info:"Errors at elements: "+c.models.length+"(models) : "+m.length+"(dom)",level:d};return}}d++;b.each(m,function(e,m,h){m=c.models[m];h=f(e);h.data("model_id",m.cid);m.set("html",e.innerHTML,{silent:!0});if(5===m.get("level")){var k=
h.data("td-block-uid");if(b.isUndefined(k)){var l=h.find(".td_block_inner, .tdb-block-inner, .td-post-sharing");l.length&&(k=l.attr("id"))}}else 3===m.get("level")?(l=h.find(".tdc-inner-row"),l.length&&(k=l.attr("id"))):1===m.get("level")&&(k=h.attr("id"));m.set("blockUid",k);new tdcIFrameData.TdcLiveView({model:m,el:e});!h.hasClass("tdc-element")&&m.has("childCollection")&&0<b.size(m.get("childCollection"))&&tdcIFrameData.bindViewsModelsWrappers(a,m.get("childCollection"),h,d)});d--}},changeRowModel:function(a,
...
function(d,m,h){if("vc_row_inner"===d.get("tag")&&(d=d.get("childCollection"),!b.isUndefined(d)&&d.length)){var k="";b.each(d.models,function(a,c,e){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(k=c===e.length-1?k+a.width:k+(a.width+"_"))});k=k.replace(/\//g,"");"12_12"!==k&&"23_13"!==k&&"13_23"!==k&&"13_13_13"!==k&&(k="");if("11"===c)if("23"===e)if("23_13"===k){var f=d.at(0),g=d.at(1);h=f.get("attrs");m=g.get("attrs");h=b.clone(h);m=b.clone(m);h.width="1/2";m.width="1/2";
f.set("attrs",h);g.set("attrs",m)}else if("13_23"===k)f=d.at(0),g=d.at(1),h=f.get("attrs"),m=g.get("attrs"),h=b.clone(h),m=b.clone(m),h.width="1/2",m.width="1/2",f.set("attrs",h),g.set("attrs",m);else if("13_13_13"===k){f=d.at(0);g=d.at(1);d=d.at(2);h=f.get("attrs");m=g.get("attrs");var l=d.get("attrs");h=b.clone(h);m=b.clone(m);b.clone(l);h.width="1/2";m.width="1/2";f.set("attrs",h);g.set("attrs",m);m=d.get("childCollection");if(!b.isUndefined(m)&&m.length){var n=g.get("childCollection");b.isUndefined(n)&&
...
c)if("11"===e)if("12_12"===k)f=d.at(0),g=d.at(1),h=f.get("attrs"),m=g.get("attrs"),h=b.clone(h),m=b.clone(m),h.width="1/3",m.width="1/3",f.set("attrs",h),g.set("attrs",m),m=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,parentModel:a}),d.add(m);else{if(d.models.length)for(f=d.at(0),h=f.get("attrs"),h=b.clone(h),r=f.get("childCollection"),delete h.width,f.set("attrs",h),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",
...
b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("13"===c)if("11"===e)if(""===k||"12_12"!==k&&"23_13"!==k&&"13_23"!==k&&"13_13_13"!==k){if(d.models.length)for(f=d.at(0),h=f.get("attrs"),h=b.clone(h),r=f.get("childCollection"),delete h.width,f.set("attrs",h),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||
b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else"12_12"===k&&d.models.length&&(f=d.at(0),g=d.at(1),h=f.get("attrs"),m=g.get("attrs"),h.width="1/3",m.width="1/3",f.set("attrs",h),g.set("attrs",m),d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===e&&(""===k||"12_12"!==k)&&d.models.length)for(f=d.at(0),h=f.get("attrs"),h=b.clone(h),r=f.get("childCollection"),
...
d=a.find('input[type="radio"]:checked'),h=a.find('input[type="text"]'),f=c.get(0),l="",g=d.data("default_value"),n=tdcIFrameData.getModel(c.data("model_id")),p=c.data("param_name"),q=window.tdcAdminSettings.mappedShortcodes[n.attributes.tag],t=n="";var v=[];for(var u=0;u<q.params.length;u++)if(p===q.params[u].param_name){u=q.params[u].tdc_values;for(var r in u)u.hasOwnProperty(r)&&(v.push(u[r].unit),""===n||""===t)&&(n=u[r].value,t=u[r].unit);break}d.length&&(l=d.data("unit_value"));if("range"===
e.attr("type"))v=c.val(),h.val(v),d.data("last_value",v),h.val(v),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+l,tdcSidebar.currentViewportSettings.name)),a.removeClass("tdc-css-inherited");else if("text"===e.attr("type")){if("input"===b.type||"change"===b.type)return;a.removeClass("tdc-css-inherited");v=h.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==v||_.isUndefined(g)||""===g?(c.val(v),d.data("last_value",v),c.data("data-to-save",
tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+l,tdcSidebar.currentViewportSettings.name))):(c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),c.data("range_value",n),c.data("range_unit",t),c.val(n),l=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=l.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+q),l.prop("checked",!0),f.min=r,f.max=d,f.step=q,f.value=n,l.data("last_value",n),h.val(n));
else if(""===v)if(l=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),"undefined"===typeof l)c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),c.data("range_value",n),c.data("range_unit",t),c.val(n),l=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=l.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+q),l.prop("checked",!0),f.min=r,f.max=d,f.step=q,f.value=n,l.data("last_value",n),h.val(n),a.addClass("tdc-css-inherited");
else for(u=0;u<q.params.length;u++){if(p===q.params[u].param_name){v=[];h=[];u=q.params[u].tdc_values;for(r in u)u.hasOwnProperty(r)&&v.push(u[r].unit);for(u=0;u<v.length&&!(h=l.split(v[u]),1<h.length);u++);h.length&&(n=h[0],t=v[u],c.data("range_value",n),c.data("range_unit",t),l=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=l.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+q),l.prop("checked",!0),f.min=r,f.max=d,f.step=q,f.value=n,l.data("last_value",n),a.find('input[type="text"]').val(n));
...
d.on("click",".tdc-property-editor_css .tdc-property-title",function(b){tdcSidebarPanel.showHideTdcCssEditor.call(this,b)});d.on("click",".tdc-property-flex_layout label",function(b){b=jQuery(this);var d=jQuery(".tdc-property-flex_horiz_align"),a=jQuery(".tdc-property-flex_vert_align"),c=jQuery(".tdc-property-flex_layout_reverse");"Row"===b.attr("title")?(d.hasClass("tdc-flex-row-align-rev")||d.addClass("tdc-flex-row-align-rev"),a.hasClass("tdc-flex-row-align-rev")||a.addClass("tdc-flex-row-align-rev"),
c.find("input").is(":checked")&&(d.hasClass("tdc-flex-row-rev-align-rev")||d.addClass("tdc-flex-row-rev-align-rev"))):(d.hasClass("tdc-flex-row-align-rev")&&d.removeClass("tdc-flex-row-align-rev"),a.hasClass("tdc-flex-row-align-rev")&&a.removeClass("tdc-flex-row-align-rev"),d.hasClass("tdc-flex-row-rev-align-rev")&&d.removeClass("tdc-flex-row-rev-align-rev"))});d.on("change",".tdc-property-flex_layout_reverse input",function(b){b=jQuery(this);var d=jQuery(".tdc-property-flex_layout .tdc-property-input-radio:checked"),
a=jQuery(".tdc-property-flex_horiz_align");"column"===d.val()&&(b.is(":checked")?a.hasClass("tdc-flex-row-rev-align-rev")||a.addClass("tdc-flex-row-rev-align-rev"):a.hasClass("tdc-flex-row-rev-align-rev")&&a.removeClass("tdc-flex-row-rev-align-rev"))});d.on("mousedown",function(b){var d=jQuery("#tdc-sidebar"),a=jQuery("#tdc-icon-selector"),c=jQuery("#tdc-gradient"),m=jQuery("#tdc-palette"),h=jQuery("#tdc-font-list"),f=jQuery(".tdc-preset-values-list");a.length?a.get(0).contains(b.target)||(a.hide(),
d.after(a)):a=tdcSidebar.buildIconSelector();c.length?c.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-gradient-wrap")||(c.hide(),d.after(c))):c=tdcSidebar.buildGradient();m.length?m.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-colorpicker-wrap")||(m.hide(),d.after(m),m.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):m=tdcSidebar.buildPalette();h.length&&!h.get(0).contains(b.target)&&(h.hide(),d.after(h));!f.length||f.get(0).contains(b.target)||
jQuery(".tdc-preset-values").get(0).contains(b.target)?f.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(b.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0)},100):f.is(":visible")&&(f.hide(),d=jQuery(b.target),
jQuery(".tdc-top-buttons").get(0).contains(b.target)||d.hasClass("tdc-top-buttons")||jQuery(".tdc-sidebar-bottom").get(0).contains(b.target)||d.hasClass("tdc-sidebar-bottom")||jQuery(".tdc-current-element-head").get(0).contains(b.target)||d.hasClass("tdc-current-element-head")?jQuery(".tdc-current-element-head").get(0).contains(b.target)||d.hasClass("tdc-current-element-head")?(tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),
...
f="",l=0;l<h.length;l++){var g=b.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+h[l]+":first");if(g.length){var n=g.find('[data-model_id="'+a+'"]');n.length&&(n.val(""),n.data("responsive",""),g.removeClass("tdc-css-inherited"),f=g.find(".tdc-inherit"),f.length&&f.hide(),f=n.data("placeholder"),"undefined"!==typeof f&&n.attr("placeholder",f),f=n.data("param_name"),delete d[f],n=n.attr("name"),tdcSidebarPanel.deleteResponsiveValues(n))}}c.set("attrs",d);tdcSidebarController.onUpdate(c,f,"","")}})});
...
function(b){jQuery('<div class="tdc-font-settings" data-value="'+b.value+'" data-model_id="'+a+'" data-param_name="'+c+'"><span class="tdc-font-name">'+b.name+'</span><span class="tdc-font-delete"></span></div>').appendTo(f)}));if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(f);b=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var h=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<
h;h--){var k=window.tdcAdminSettings.tdcSavings.recentFonts[h],l=b[k];_.isUndefined(l)||jQuery('<div class="tdc-recent-font-settings" data-value="'+k+'" data-model_id="'+a+'" data-param_name="'+c+'"><span class="tdc-font-name">'+l+'</span><span class="tdc-recent-font-delete"></span></div>').appendTo(f)}}d.after(f);f.toggle()}});d.on("click",".tdc-font-delete",function(b){b.stopImmediatePropagation();var d=jQuery(this).closest(".tdc-font-settings");b=d.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,
...
b){_.isUndefined(b)&&(b=jQuery(d.currentTarget).data("model_id"),b=tdcIFrameData.getModel(b),d={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,d));var e=b.get("tag");b=b.get("attrs");b=_.clone(b);if(!_.isUndefined(b)){var a={};d={};for(var c in b)0===c.indexOf("tds_")&&(a[c]=b[c]);c=window.tdcAdminSettings.mappedShortcodes[e].params;for(e=0;e<c.length;e++){var m=!1,h=c[e];if(0===h.param_name.indexOf("tds_")){for(var k in a)if(h.param_name===k){d[k]=a[k];m=!0;break}m||(d[h.param_name]=
"")}}for(k in a)switch(a=k.split("-"),a.length){case 2:if(!_.has(d,k)){c=a[0];a=!1;for(var l in d)if(c===d[l]&&1===l.split("-").length){a=!0;break}if(!a){var g;for(g in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[g],c)){var n=g;break}_.has(d,n)&&""===d[n]&&window.tdcAdminSettings.globalStyle[n]===c&&(a=!0)}a||delete b[k]}break;case 3:c=a[0];e=a[2];for(g in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[g],c)){n=g;break}a=
!1;for(l in d)if(c===d[l]&&l===n+"-"+e){a=!0;break}a||_.has(d,n+"-"+e)&&""===d[n+"-"+e]&&window.tdcAdminSettings.globalStyle[n]===c&&(a=!0);a||delete b[k]}return b}},getCurrentListAtts:function(d,b,e){_.isUndefined(b)&&(d=jQuery(d.currentTarget).data("model_id"),b=tdcIFrameData.getModel(d),d={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,d));d=b.get("tag");b=b.get("attrs");var a=_.clone(b);if(!_.isUndefined(a)){var c={};b={};for(var m in a)0===m.indexOf("tds_")&&(c[m]=a[m]);m=window.tdcAdminSettings.mappedShortcodes[d].params;
for(var h=0;h<m.length;h++){var k=!1,l=m[h];if(0===l.param_name.indexOf("tds_")){for(var g in c)if(l.param_name===g){b[g]=c[g];k=!0;break}k||(b[l.param_name]="")}}for(g in c)switch(c=g.split("-"),c.length){case 2:if(!_.has(b,g)){m=c[0];c=!1;for(var n in b)if(m===b[n]&&1===n.split("-").length){c=!0;break}if(!c){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],m)){var q=p;break}_.has(b,q)&&""===b[q]&&window.tdcAdminSettings.globalStyle[q]===m&&(c=
!0)}c||delete a[g]}break;case 3:m=c[0];k=c[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],m)){q=p;break}c=!1;for(n in b)if(m===b[n]&&n===q+"-"+k){c=!0;break}c||_.has(b,q+"-"+k)&&""===b[q+"-"+k]&&window.tdcAdminSettings.globalStyle[q]===m&&(c=!0);c||delete a[g]}var t=[],v;for(v in window.tdcAdminSettings.listStyles[e])if(v===d){for(h=0;h<window.tdcAdminSettings.listStyles[e][v].length;h++)g=window.tdcAdminSettings.listStyles[e][v][h],_.isArray(g)?
_.map(g,function(c){_.isUndefined(a[c])||(_.isUndefined(t[h])&&(t[h]=[]),t[h].push(a[c]))}):_.isUndefined(a[g])||(_.isArray(a[g])&&a[g].length?t[h]=a[g][0]:t[h]=a[g]);break}return t}},showHideTdcCssEditor:function(d){d=jQuery("#tdc-editor-css");var b=jQuery(this).closest(".tdc-property-wrap"),e=b.find("textarea:first");d.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=e;b.next("#tdc-editor-css").length?d.toggle():(b.after(d),d.show(),tdcSidebar.editorCss.getSession().setValue(e.val()))},
...
(c=b.params[a].group);e.push(c)}e=_.uniq(e);var f=c="",h=tdcSidebar.getCurrentTabId(),k,l;c+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var g=l=k="";for(a=0;a<e.length;a++){f=tdcSidebarPanel._fixGroupName(e[a]);var n=tdcUtil.makeSafeForCSS(f);0===a?(k='<a href="#" data-tab-id="td-tab-'+n+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>',l='<a href="#" data-tab-id="td-tab-'+n+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>'):
_.isUndefined(h)||h!=="td-tab-"+n?g+='<a href="#" data-tab-id="td-tab-'+n+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>':(k=l,g+='<a href="#" data-tab-id="td-tab-'+n+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>')}f=n=l=a="";switch(tdcSidebar.currentViewportSettings.name){case "all":a="selected";break;case "landscape":l="selected";break;case "portrait":n="selected";break;case "phone":f="selected"}c=c+(k+g)+'</div><div class="tdc-tab-responsive">';
c+='<div class="tdc-responsive-buttons">';c+='<div class="tdc-responsive-all '+a+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>';"Newspaper"===window.tdcAdminSettings.themeName&&(c+='<div class="tdc-responsive-tablet-landscape '+l+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>');c+='<div class="tdc-responsive-tablet-portrait '+n+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>';c+='<div class="tdc-responsive-phone '+
f+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>';c+="</div>";c+="</div>";c+='<div class="tdc-search">';c+='<i class="td-icon-search"></i>';c+='<input type="text" placeholder="Search settings..." />';c+="</div></div>";c+='<div class="tdc-sidebar-sticky-a"></div>';c+='<div class="tdc-sidebar-sticky-b"></div>';c+='<div class="tdc-tab-content-wrap">';g=l=k="";for(a=0;a<e.length;a++){f=tdcSidebarPanel._fixGroupName(e[a]);n=tdcUtil.makeSafeForCSS(f);f="tdc-tab-no-design";var p=d.get("tag");
"css"===n&&(f="tdc-tab-design");0===a?(k='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+n+'">',l='<div class="tdc-tab-content '+f+'" id="td-tab-'+n+'">',n=window.tdcAdminSettings.mappedShortcodes[p].tdc_start_values,d.unset("presetValues"),_.isUndefined(n)||(n=JSON.parse(window.atob(n)),_.isArray(n)&&1<n.length&&d.set("presetValues",n)),d.has("presetValues")&&(n=d.get("presetValues"),g+=tdcSidebarPanel._addPresetValuesSelector(n,d))):_.isUndefined(h)||h!=="td-tab-"+n?g+=
'<div class="tdc-tab-content '+f+'" id="td-tab-'+n+'">':(k=l,g+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+n+'">');g+=tdcSidebarPanel._bindGroupAndGetHtml(e[a],b,d);n=' data-model_id="'+d.cid+'" ';"dev"===window.tdcAdminSettings.deployMode&&(g+='<div class="tdc-sidebar-row-buttons">',g+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+n+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>',g+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+
n+' title="Get the current styles\' settings">CONSOLE: style presets</div>',g+="</div>");g+="</div>"}c=c+(k+g)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(c);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");tdcSidebarPanel._hook.addAction("panel_rendered",function(){"undefined"===typeof window.tdcResponsiveValues&&(window.tdcResponsiveValues={},"all"===tdcSidebar.currentViewportSettings.name?jQuery(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"):jQuery(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),
jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),c=a.find("[data-responsive]"),b=c.attr("name"),d=c.data("responsive");try{var e=window.atob(d);window.tdcResponsiveValues[b]=JSON.parse(e)}catch(w){d={},a.hasClass("tdc-property-textfield-responsive")?""!==c.val()&&(d.all=c.val()):a.hasClass("tdc-property-dropdown-responsive")?a.hasClass("tdc-visual-selector")?(c=a.find("[data-responsive]:checked:first"),c.length?d.all=c.val():(c=a.find("[data-responsive]:first"),
c.length&&(d.all=c.val()))):c.find("option:first").val()!==c.val()&&(d.all=c.val()):a.hasClass("tdc-property-checkbox-responsive")?c.is(":checked")&&(d.all=c.val()):a.hasClass("tdc-property-range-responsive")?d.all=c.data("value"):a.hasClass("tdc-property-range_multiple-responsive")&&(d.all=c.data("range_value")+c.data("range_unit")),window.tdcResponsiveValues[b]=d}tdcSidebarPanel.setViewportCurrentResponsiveValue(c)}))});tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-tab-content-wrap").find('select[name$="font_family"]').change(function(a){a=
jQuery(this).val();""===window.tdcAdminSettings.tdcSavings&&(window.tdcAdminSettings.tdcSavings={});"undefined"===typeof window.tdcAdminSettings.tdcSavings.recentFonts&&(window.tdcAdminSettings.tdcSavings.recentFonts=[]);var c=window.tdcAdminSettings.tdcSavings.recentFonts.indexOf(a);-1!==c&&window.tdcAdminSettings.tdcSavings.recentFonts.splice(c,1);window.tdcAdminSettings.tdcSavings.recentFonts.push(a);20<=window.tdcAdminSettings.tdcSavings.recentFonts.length&&window.tdcAdminSettings.tdcSavings.recentFonts.splice(0,
...
a.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col");break;case "23":a.parent().find("input[value=12_12] + label").removeClass("tdc-block-col"),a.parent().find("input[value=23_13] + label").addClass("tdc-block-col"),a.parent().find("input[value=13_23] + label").addClass("tdc-block-col"),a.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})();(function(){var a=d.get("tag");if("vc_row"===a||"vc_row_inner"===a||"vc_column"===a||"vc_column_inner"===a){a=
jQuery("body .tdc-property-flex_layout");var c=d.get("childCollection");if(!_.isUndefined(c)&&a.length){c=jQuery("body .tdc-property-flex_horiz_align");var b=jQuery("body .tdc-property-flex_vert_align"),e=jQuery("body .tdc-property-flex_layout_reverse");a.find("input[value=column]").is(":checked")&&(c.addClass("tdc-flex-row-align-rev"),b.addClass("tdc-flex-row-align-rev"),e.find("input").is(":checked")&&c.addClass("tdc-flex-row-rev-align-rev"))}}})()}},_bindGroupAndGetHtml:function(d,b,e){var a="",
c=e.get("attrs");if("tdc_zone"===e.get("tag"))var f=c.type;for(var h=0;h<b.params.length;h++){var k=b.params[h].param_name,l=b.params[h].group;if(d===tdcSidebarPanel._defaultGroupName&&_.isEmpty(b.params[h].group)||b.params[h].group===d){if(!_.isUndefined(f)&&(!_.isUndefined(b.params[h].zone_group)&&f!==b.params[h].zone_group||"type"===k))continue;a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[h],e)}if("block_template_id"===k){l=c.block_template_id;_.isEmpty(l)&&(l=window.tdcAdminSettings.globalBlockTemplate);
k=window.tdcAdminSettings.mappedBlockTemplates;for(var g=0;g<k[l].params.length;g++)if(d===tdcSidebarPanel._defaultGroupName&&_.isEmpty(k[l].params[g].group)||k[l].params[g].group===d)a+=tdcSidebarPanel._bindParamAndGetHtml(k[l].params[g],e)}else if(0===k.indexOf("tds_")){var n=k.split("-");g=n[0];var p;2===n.length?p=n[1]:2<n.length&&new tdcNotice.notice('Param "'+k+'" must have up to at most one "-" separator ',!0,!1);k=c[k];_.isEmpty(k)&&(k=window.tdcAdminSettings.globalStyle[g]);n=window.tdcAdminSettings.settingsStyle[g];
for(g=0;g<n[k].params.length;g++)if(l==d||_.isUndefined(l)&&d===tdcSidebarPanel._defaultGroupName){var q=JSON.parse(JSON.stringify(n[k].params[g]));q.param_name=k+"-"+q.param_name;_.isUndefined(p)||(q.param_name+="-"+p);a+=tdcSidebarPanel._bindParamAndGetHtml(q,e)}}}return a},_bindParamAndGetHtml:function(d,b){switch(d.type){case "custom":return tdcSidebarPanel.addCustom(d,b);case "colorpicker":return tdcSidebarPanel.addColorpicker(d,b);case "gradient":return tdcSidebarPanel.addGradient(d,b);case "dropdown":return tdcSidebarPanel.addDropDown(d,
...
"menu_id"===d.param_name){var e=b.get("attrs");e.menu_id=window.tdcPostSettings.mobileMenuId;b.set("attrs",e)}var a=e=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",h=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&h.length<=parseInt(d.tdc_min_options))return c;for(var k=0;k<h.length;k++){var l=!1,g="",n="",p=h[k],q=String(tdcSidebarPanel._getParameterCurrentValue(d,b)),t=String(d.value[h[k]]);
_.isObject(d.value[h[k]])&&(l=!0,t=_.values(d.value[h[k]])[0],p=_.keys(d.value[h[k]])[0]);e||a?(0===k&&""===q&&(q=t),q===t&&(g=" checked "),n=_.uniqueId(),q=t,"vc_row"!==b.attributes.tag&&"vc_row_inner"!==b.attributes.tag||-1!==d.param_name.indexOf("flex_")||(q="col_"+q),f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+n+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+g+' value="'+t+'">',e?(g="",l&&(g="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+
g+'" for="'+n+'" title="'+p+'"><div class="'+q+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+n+'" title="'+p+'">'+t+"</label>"):(q===t&&(g=' selected="selected" '),"__"===t&&-1!==p.search("--")&&(n=" disabled "),f+="<option "+g+" "+n+' value="'+t+'">'+p+"</option>")}h="";_.has(d,"description")&&""!==d.description&&(h=' title="'+d.description+'" ');c+='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+
h+">"+d.heading+"</span></div>";c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'">',c=c+f+"</select>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return c+"</div>"},addDropDownResponsive:function(d,b){var e=!1,a=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",h=Object.keys(d.value);
if(_.has(d,"tdc_min_options")&&h.length<=parseInt(d.tdc_min_options))return c;var k=' data-responsive="" ',l=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var g=JSON.parse(window.atob(l));k=' data-responsive="'+l+'" ';"undefined"!==typeof g[tdcSidebar.currentViewportSettings.name]&&(l=g[tdcSidebar.currentViewportSettings.name])}catch(r){}for(g=0;g<h.length;g++){var n=!1,p="",q=h[g],t=String(d.value[h[g]]);_.isObject(d.value[h[g]])&&(n=!0,t=_.values(d.value[h[g]])[0],q=_.keys(d.value[h[g]])[0]);
if(e||a){0===g&&""===l&&(l=t);l===t&&(p=" checked ");var v=_.uniqueId(),u=t;"vc_row"!==b.attributes.tag&&"vc_row_inner"!==b.attributes.tag||-1!==d.param_name.indexOf("flex_")||(u="col_"+u);f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+p+' value="'+t+'" '+k+">";e?(p="",n&&(p="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+p+'" for="'+v+'" title="'+q+'"><div class="'+
u+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+v+'" title="'+q+'">'+t+"</label>"}else l===t&&(p=' selected="selected" '),f+="<option "+p+' value="'+t+'">'+q+"</option>"}h="";_.has(d,"description")&&""!==d.description&&(h=' title="'+d.description+'" ');c+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+h+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';
c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+k+h+">",c=c+f+"</select>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return c+"</div>"},addCheckBox:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(a=" checked ");var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+
...
var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);var h="";_.has(d,"value")&&""!==d.value&&(h=d.value);var k="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(k=tdcSidebarPanel._getParameterCurrentValue(d,b));var l='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';l+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";l=l+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+
'" type="range" data-value="'+k+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+k+'" />');l=l+('<input type="text" class="tdc_range_value" data-default_value="'+h+'" value="'+k+'"/></div><span class="tdc-param-name">')+(d.param_name+"</span>");return l+="</div>"},addRangeResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);
var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);var h="";_.has(d,"value")&&""!==d.value&&(h=d.value);""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&tdcSidebarPanel._getParameterCurrentValue(d,b);var k="";_.has(d,"placeholder")&&""!==d.placeholder&&(k=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var l=' data-responsive="" ',g=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var n=
JSON.parse(window.atob(g));l=' data-responsive="'+g+'" ';g="undefined"===typeof n[tdcSidebar.currentViewportSettings.name]?"":n[tdcSidebar.currentViewportSettings.name]}catch(p){}n='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';n+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";n=n+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" data-value="'+
g+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+g+'" '+l+" />");n=n+('<input type="text" class="tdc_range_value" data-default_value="'+h+'" '+k+' value="'+g+'"/></div><span class="tdc-param-name">')+(d.param_name+"</span>");return n+="</div>"},addRangeMultiple:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",h="",k=[],l=
"",g="",n="",p="",q="",t="",v="",u;for(u in a)a.hasOwnProperty(u)&&(k.push(a[u].unit),""===g||""===l)&&(p=a[u].unit,g=' data-range_unit="'+p+'" ',n=a[u].value,l=' data-range_value="'+n+'" ',q=a[u].range_min,t=a[u].range_max,v=a[u].range_step);if(""!==c){for(var r=[],w=0;w<k.length&&!(r=c.split(k[w]),1<r.length);w++);r.length&&(p=k[w],g=' data-range_unit="'+p+'" ',n=r[0],l=' data-range_value="'+n+'" ')}for(u in a)a.hasOwnProperty(u)&&(c=_.uniqueId(),f+=" data-value_"+u+'="'+a[u].value+'" ',f+=" data-min_"+
u+'="'+a[u].range_min+'" ',f+=" data-max_"+u+'="'+a[u].range_max+'" ',f+=" data-step_"+u+'="'+a[u].range_step+'" ',k=a[u].value,r="",a[u].unit===p&&(k=n,q=a[u].range_min,t=a[u].range_max,v=a[u].range_step,r="checked"),h+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+u+'" data-unit_value="'+a[u].unit+'" type="radio" id="'+c+'" '+r+' data-default_value="'+a[u].value+'" data-last_value="'+k+'"/>',h+='<label for="'+c+'">'+a[u].unit+"</label>");a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+
'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+l+" "+g+" "+f+' min="'+q+'" max="'+t+'" step="'+v+'" value="'+n+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+h+'</div><input type="text" class="tdc_range_value" value="'+(n+'"/>');
a+="</div>";a+="</div>";a+='<span class="tdc-param-name">'+d.param_name+"</span>";return a+="</div>"},addRangeMultipleResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",h="",k=[],l=' data-responsive="" ',g="",n="",p="",q="",t="",v="",u="",r;for(r in a)a.hasOwnProperty(r)&&(k.push(a[r].unit),""===n||""===g)&&(q=a[r].unit,n=' data-range_unit="'+q+'" ',p=a[r].value,g=
' data-range_value="'+p+'" ',t=a[r].range_min,v=a[r].range_max,u=a[r].range_step);if(""!==c){var w=c;try{var A=JSON.parse(window.atob(c));l=' data-responsive="'+c+'" ';w="undefined"===typeof A[tdcSidebar.currentViewportSettings.name]?"":A[tdcSidebar.currentViewportSettings.name]}catch(x){}if(""!==w){c=[];for(A=0;A<k.length&&!(c=w.split(k[A]),1<c.length);A++);c.length&&(q=k[A],n=' data-range_unit="'+q+'" ',p=c[0],g=' data-range_value="'+p+'" ')}}for(r in a)a.hasOwnProperty(r)&&(k=_.uniqueId(),f+=" data-value_"+
r+'="'+a[r].value+'" ',f+=" data-min_"+r+'="'+a[r].range_min+'" ',f+=" data-max_"+r+'="'+a[r].range_max+'" ',f+=" data-step_"+r+'="'+a[r].range_step+'" ',w=a[r].value,c="",a[r].unit===q&&(w=p,t=a[r].range_min,v=a[r].range_max,u=a[r].range_step,c="checked"),h+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+r+'" data-unit_value="'+a[r].unit+'" type="radio" id="'+k+'" '+c+' data-default_value="'+a[r].value+'" data-last_value="'+w+'"/>',h+='<label for="'+k+'">'+a[r].unit+
"</label>");a='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+g+" "+n+" "+f+" "+l+' min="'+t+'" max="'+v+'" step="'+u+'" value="'+p+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+
...
d.description===c.text()?e=' title="'+d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var f=' data-responsive="" ',h=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var k=JSON.parse(window.atob(h));f=' data-responsive="'+h+'" ';h="undefined"===typeof k[tdcSidebar.currentViewportSettings.name]?"":k[tdcSidebar.currentViewportSettings.name]}catch(l){}k=
'<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';k+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";k=k+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" value="'+h+'" '+c+f+e+"/>");k=k+a+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return k+="</div>"},addTextAreaHtml:function(d,b){_.has(d,"description");
...
h=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];a=[];for(var k=c="",l=0;l<h.params.length;l++)if(f===h.params[l].param_name){f=h.params[l].tdc_values;for(var g in f)f.hasOwnProperty(g)&&(a.push(f[g].unit),""===c||""===k)&&(c=f[g].value,k=f[g].unit);break}_.isUndefined(b)?(b=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),_.isUndefined(b)&&(d.data("range_value",c),d.data("range_unit",k),d.val(c),g=e.find('input[type="radio"][data-unit_value="'+k+'"]'),l=g.data("unit"),
f=d.data("min_"+l),k=d.data("max_"+l),l=d.data("step_"+l),h=d.get(0),g.prop("checked",!0),h.min=f,h.max=k,h.step=l,h.value=c,g.data("last_value",c),e.find('input[type="text"]').val(c)),"all"===tdcSidebar.currentViewportSettings.name?e.removeClass("tdc-css-inherited"):e.addClass("tdc-css-inherited")):e.removeClass("tdc-css-inherited");if(!_.isUndefined(b)){c=[];for(l=0;l<a.length&&!(c=b.split(a[l]),1<c.length);l++);c.length&&(c=c[0],k=a[l],d.data("range_value",c),d.data("range_unit",k),d.val(c),g=
e.find('input[type="radio"][data-unit_value="'+k+'"]'),l=g.data("unit"),f=d.data("min_"+l),k=d.data("max_"+l),l=d.data("step_"+l),h=d.get(0),g.prop("checked",!0),h.min=f,h.max=k,h.step=l,h.value=c,g.data("last_value",c),e.find('input[type="text"]').val(c))}}},showShortcodeFromPath:function(d){if(!_.isUndefined(d)){d=d.toString().split("_");var b;d.forEach(function(a,d){""!==a&&(_.isUndefined(b)?b=tdcIFrameData.tdcTopCollection.at(a):(d=b.get("childCollection"),!_.isUndefined(d)&&d.length>a&&(b=d.at(a))))});
...
"HEADER MENU STICKY";break;case "tdc_header_mobile":a="MOBILE MENU";break;case "tdc_header_mobile_sticky":a="MOBILE MENU STICKY";break;case "tdc_footer":a="FOOTER"}tdcSidebar.$_editZone.find("a").html(a)},_activeBreadcrumbItem:function(){var b=tdcSidebar.getCurrentModel(),a=b.get("tag"),c=tdcIFrameData.getZoneParent(b).get("type_zone"),m="<span>"+window.tdcPostSettings.shortcodes[b.get("tag")]+"</span>",h="";tdcSidebar.changeZoneName(c);for(var k in window.tdcAdminSettings.mappedShortcodes)"undefined"===
typeof window.tdcAdminSettings.mappedShortcodes[k].tdc_category||"Blocks"!==window.tdcAdminSettings.mappedShortcodes[k].tdc_category&&"Big Grids"!==window.tdcAdminSettings.mappedShortcodes[k].tdc_category||window.tdcAdminSettings.mappedShortcodes[k].tdc_category!==window.tdcAdminSettings.mappedShortcodes[a].tdc_category||(c="",k===a&&(c="tdc-selected-option"),h+='<li class="'+c+'" data-block_type="'+window.tdcAdminSettings.mappedShortcodes[k].base+'"><div class="tdc-element-ico tdc-ico-'+window.tdcAdminSettings.mappedShortcodes[k].base+
'"></div><div class="tdc-element-id">'+window.tdcAdminSettings.mappedShortcodes[k].name+"</div></li>");""!==h?(h="<ul>"+h+"</ul>",tdcSidebar.$_currentElementHead.addClass("tdc-block-selection")):tdcSidebar.$_currentElementHead.removeClass("tdc-block-selection");switch(a){case "tdc_zone":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.hide();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();var l=tdcSidebar.$_editZone;break;case "vc_row":tdcSidebar.$_editZone.show();
...
tdcSidebar.$_editInnerColumn.show()):(tdcSidebar.$_editInnerRow.hide(),tdcSidebar.$_editInnerColumn.hide())}tdcSidebar.$_currentElementHead.html(m);tdcSidebar.$_currentElementSiblings.html(h);tdcSidebar.$_sidebar.find(".tdc-responsiveness").addClass(a);tdcSidebar.$_currentElementHead.off().mouseenter(function(a){a.preventDefault();l.trigger(a)}).mouseleave(function(a){a.preventDefault();l.trigger(a)}).mousedown(function(a){""!==h&&(tdcSidebar.$_currentElementSiblings.toggleClass("tdc-current-element-siblings-visible"),
...
var a;d.each(tdcAdminSettings.tdcSavings,function(c,b,e){if(c.length&&"gradients"!==b&&"fonts"!==b){var f="",h="",m=!1,k=!1;"vc_row"===b?(f="tdc-row-temp",h=' data-shortcode-name="vc_row" ',m=!0):"vc_row_inner"===b?(f="tdc-element-inner-row-temp",h=' data-shortcode-name="vc_row_inner" ',m=!0):(f="tdc-element",h=' data-shortcode-name="'+b+'" ',k=!0);d.isUndefined(window.tdcAdminSettings.mappedShortcodes[b])||(a+='<div class="tdc-sidebar-separator tdc-sidebar-text-separator"><span>'+window.tdcAdminSettings.mappedShortcodes[b].name+
"</span></div>",d.each(c,function(c,e,g){g=e="";m&&(g=c.shortcode,g=window.atob(g),g=' data-template-content="'+window.btoa(g)+'" ');k&&(tdcIFrameData._getPostOriginalContentJSON(),e=tdcIFrameData._getContentJSON(5,window.atob(c.shortcode)),d.isUndefined(e[0].shortcode.content)||(e[0].shortcode.attrs.named.content=e[0].shortcode.content),e=' data-start-values="'+window.btoa(JSON.stringify([e[0].shortcode.attrs.named]))+'" ');a+='<div class="tdc-sidebar-element '+f+'" '+h+" "+g+" "+e+'><div class="tdc-element-ico tdc-ico-template"></div><div class="tdc-element-id">'+
...
c=a.val();var h=1;a.hasClass("tdc-css-opacity")&&(h=.01);var k=NaN;switch(b.type){case "keyup":switch(b.keyCode){case 38:f.isNumeric(c)&&(k=parseFloat(c)+h);break;case 40:f.isNumeric(c)&&(k=parseFloat(c)-h)}break;case "mousewheel":b.preventDefault(),b.stopImmediatePropagation(),f.isNumeric(c)&&(k=0<b.originalEvent.deltaY?parseFloat(c)-h:parseFloat(c)+h)}d.isNaN(k)||(1>h&&(k=k.toFixed(2)),a.val(k));tdcCssEditor._updateData(a);c=e.data("tdc-for");b={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,
...
e){a=f(e);e=a.closest(".tdc-property-wrap");var c=e.find(".tdc-css-image-remove"),m=e.find(".tdc-inherit-image"),l={isInherited:!1},g=tdcCssEditor._getSettingsProperty("background-image",b,l);l.isInherited?e.addClass(tdcCssEditor._INHERITED_CSS_CLASS):e.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);d.isUndefined(g)?(c.addClass("tdc-hidden-button"),m.hide()):("no_value"===g?c.addClass("tdc-hidden-button"):(c.removeClass("tdc-hidden-button"),a.attr("style",'background-image: url("'+g+'")')),"all"!==
...
a+'"':""}function c(){return l.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function m(a,b){b=tdcCssEditor._getSettingsProperty(a,b,e());var f="-",m="";l.isInherited&&(f=b,b="");d.isUndefined(k)||"margin-left"!==a&&"margin-right"!==a||(m=k.get("tag"),m="vc_column"===m||"vc_column_inner"===m?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+a+'" name="" type="text" value="'+b+'" class="tdc-css-box-input tdc-css-box-input-'+a+c()+m+'" title="Css '+a+'" placeholder="'+f+
'" '+tdcSidebarPanel._getParamterDataAtts(h,k)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var h=tdcCssEditor._mappedParameter,k=tdcCssEditor._model,l={isInherited:!1};var g='<div class="tdc-responsiveness"><div class="'+(tdcSidebarPanel._getParameterClasses(h)+'">');g=g+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+m("margin-top","");g+=m("margin-right","");g+=m("margin-bottom","");g+=m("margin-left","");g=g+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+
...
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"solid",display:"Solid"},{value:"dotted",display:"Dotted"},{value:"dashed",display:"Dashed"},{value:"none",display:"None"},{value:"hidden",display:"Hidden"},{value:"double",display:"Double"},{value:"groove",display:"Groove"},{value:"ridge",display:"Ridge"},{value:"inset",display:"Inset"},{value:"outset",display:"Outset"},{value:"initial",display:"Initial"},{value:"inherit",display:"Inherit"}],
n);g+="</select></div></div>";n=d.uniqueId();var p=tdcCssEditor._getSettingsProperty("border-color","",e()),q="";l.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+c()+'" data-tdc-for="border-color">';g=g+'<div class="tdc-property-title"><span title="Css border-color" class="tdc-search-data">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(h,k)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("border-radius","",e());p="";l.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+c()+'" data-tdc-for="border-radius">';g=g+'<div class="tdc-property-title"><span title="Css border-radius" class="tdc-search-data">Border radius</span></div><div class="tdc-property"><input class="tdc-css-border-radius" '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("width","",e());p="";l.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+c()+'" data-tdc-for="width">';g=g+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Width</span></div><div class="tdc-property"><input class="tdc-css-width" '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("shadow-size","",e());p="";l.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-size">';g=g+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Shadow size</span></div><div class="tdc-property"><input class="tdc-css-shadow-size" '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("shadow-color","",e());q="";l.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+c()+'" data-tdc-for="shadow-color">';g=g+'<div class="tdc-property-title"><span title="Css shadow-color" class="tdc-search-data">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(h,k)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-h","",e());p="";l.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-h">';g=g+'<div class="tdc-property-title"><span title="Css shadow-offset-h" class="tdc-search-data">Shadow offset H</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-h" '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-v","",e());p="";l.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-v">';g=g+'<div class="tdc-property-title"><span title="Css shadow-offset-v" class="tdc-search-data">Shadow offset V</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-v" '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("background-color","",e());q="";l.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+c()+'" data-tdc-for="background-color">';g=g+'<div class="tdc-property-title"><span title="Css background-color" class="tdc-search-data">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(h,k)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",b,e());g+='<div class="tdc-property-wrap tdc-property-attach_image'+c()+'">';g=g+'<div class="tdc-property-title"><span title="Css background-image" class="tdc-search-data">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property"><div class="tdc-css-bg-image tdc-css-image-wrap " '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+" style=\"background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png' )\"></div>");g+='<a class="tdc-css-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';n=tdcCssEditor._getSettingsProperty("background-style",b,e());g+='<div class="tdc-property-wrap tdc-bg-style tdc-dropdown-big'+c()+'" data-tdc-for="background-style">';g=g+'<div class="tdc-property-title"><span title="Css background-size & background-repeat" class="tdc-search-data">Background style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-bg-style" '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"cover",display:"Cover"},{value:"contain",display:"Contain"},{value:"no-repeat",display:"No repeat"},{value:"repeat",display:"Repeat"}],n);g+="</select></div></div>";n=tdcCssEditor._getSettingsProperty("background-position",b,e());g+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="background-position">';g=g+'<div class="tdc-property-title"><span title="Css background-position" class="tdc-search-data">Background position<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-bg-position" '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"center top",display:"Center Top"},{value:"center center",display:"Center Center"},{value:"center bottom",display:"Center Bottom"},{value:"left top",display:"Left Top"},{value:"left center",display:"Left Center"},{value:"left bottom",display:"Left Bottom"},{value:"right top",display:"Right Top"},{value:"right center",display:"Right Center"},{value:"right bottom",display:"Right Bottom"}],n);g+=
"</select></div></div>";n=tdcCssEditor._getSettingsProperty("opacity","",e());p="";l.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="opacity">';g=g+'<div class="tdc-property-title"><span title="Css background-image opacity" class="tdc-search-data">Background opacity</span></div><div class="tdc-property"><input class="tdc-css-opacity" '+(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-1-overlay","",e());q="";l.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+c()+'" data-tdc-for="color-1-overlay">';g=g+'<div class="tdc-property-title"><span title="Css gradient color From" class="tdc-search-data">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(h,k)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-2-overlay","",e());q="";l.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+c()+'" data-tdc-for="color-2-overlay">';g=g+'<div class="tdc-property-title"><span  title="Css gradient color To" class="tdc-search-data">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(h,k)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("gradient-direction","",e());p="";l.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="gradient-direction">';g=g+'<div class="tdc-property-title"><span title="Css gradient direction" class="tdc-search-data">Gradient direction</span></div><div class="tdc-property"><input class="tdc-css-gradient-direction" '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=tdcCssEditor._getSettingsProperty("content-h-align",b,e());g+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="content-h-align">';g=g+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-content-h-align" '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],n);g+="</select></div></div>";n=tdcCssEditor._getSettingsProperty("z-index","",e());p="";l.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="z-index">';g=g+'<div class="tdc-property-title"><span title="Z-index" class="tdc-search-data">Z-index</span></div><div class="tdc-property"><input class="tdc-css-z-index" '+
(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsPropertyFromCssSettings("display",b);g+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+c()+'" data-tdc-for="display">';g=g+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">Display</span></div><div class="tdc-property"><select class="tdc-css-display" '+(tdcSidebarPanel._getParamterDataAtts(h,k)+' name="">');
...
k)+' title="Clear all tab css settings">Clear CSS settings</div>');g+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){f(".tdc-inherit").each(function(a,c){a=f(c);c=a.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||c.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))a.hide();else{var e=c.data("tdc-for");c={isInherited:!1};e=tdcCssEditor._getSettingsProperty(e,b,c);c.isInherited?
...
k=!1,l=0,g=0;g<b.length;g++)d.isUndefined(c)||c!==b[g].value||(l=g),f="",d.isUndefined(a)||a!==b[g].value||(f='selected="selected"',k=!0),e.push("<option "+f+' value="'+b[g].value+'">'+b[g].display+"</option>");k||(e[l]='<option selected="selected" value="'+b[l].value+'">'+b[l].display+"</option>");return e.join("")},_generateCssAttValue:function(b){var a={},c=b.find(".tdc-css-box-input-margin-top").val().trim(),e=b.find(".tdc-css-box-input-margin-right").val().trim(),f=b.find(".tdc-css-box-input-margin-bottom").val().trim(),
k=b.find(".tdc-css-box-input-margin-left").val().trim(),l=b.find(".tdc-css-box-input-border-top-width").val().trim(),g=b.find(".tdc-css-box-input-border-right-width").val().trim(),n=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),p=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),t=b.find(".tdc-css-box-input-padding-right").val().trim(),v=b.find(".tdc-css-box-input-padding-bottom").val().trim(),u=b.find(".tdc-css-box-input-padding-left").val().trim(),
r=b.find(".tdc-css-border-radius").val().trim(),w=b.find(".tdc-css-width").val().trim(),A=b.find(".tdc-css-shadow-size").val().trim(),x=b.find(".tdc-css-shadow-offset-h").val().trim(),z=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),C=b.find(".tdc-css-z-index").val().trim();""!==c&&(a["margin-top"]=c);""!==e&&(a["margin-right"]=e);""!==f&&(a["margin-bottom"]=f);""!==k&&(a["margin-left"]=k);""!==l&&(a["border-top-width"]=
l);""!==g&&(a["border-right-width"]=g);""!==n&&(a["border-bottom-width"]=n);""!==p&&(a["border-left-width"]=p);""!==q&&(a["padding-top"]=q);""!==t&&(a["padding-right"]=t);""!==v&&(a["padding-bottom"]=v);""!==u&&(a["padding-left"]=u);c=b.find(".tdc-css-border-style");e=c.val().trim();""===e||c.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=e);c=b.find(".tdc-css-border-color");e=c.val().trim();""!==e?a["border-color"]=e:(c=c.data("no_value"),d.isUndefined(c)||
...
h=f(".tdc-gradient-color-values"),k=f(".tdc-color-values");-1!==e&&(d.tdcAdminSettings.tdcSavings.recentColors.splice(e,1),f('.tdc-color-value[data-color="'+a+'"]').remove(),f('.tdc-gradient-color-value[data-color="'+a+'"]').remove());d.tdcAdminSettings.tdcSavings.recentColors.push(b);23<=d.tdcAdminSettings.tdcSavings.recentColors.length&&(k.find(".tdc-color-value:last").remove(),h.find(".tdc-gradient-color-value:last").remove(),d.tdcAdminSettings.tdcSavings.recentColors.splice(0,1));tdcUtil.updateTdcSavings();
k.prepend('<div class="tdc-color-value" data-color="'+a+'" style="background-color:'+a+'"><div class="tdc-color-value-delete"></div>');h.prepend('<div class="tdc-gradient-color-value" data-color="'+a+'" style="background-color:'+a+'"><div class="tdc-gradient-color-value-delete"></div>')}}});"undefined"===typeof f.fn.tdGradient&&(f.fn.tdGradient=function(){return this.each(function(){var a=this,b=f(this);a.$this=b;if(!1!==b.data("rgba")){var m=f.cs_ParseColorValue(b.val());b.tdGradientColorPicker({clear:function(){b.trigger("keyup")},
change:function(c,d){c=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",c);b.val(c).trigger("change");a.triggerSelection?a.setColor(c,!0):a.setColor(c)},create:function(){var c=b.data("a8cIris"),k=b.closest(".wp-picker-container"),l=f('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(k.find(".wp-picker-holder")),g=l.find(".cs-alpha-slider"),
n=l.find(".cs-alpha-text"),p=l.find(".cs-alpha-slider-offset"),q=f('<div class="tdc-gradient-result-wrap"></div>').prependTo(k);q=f('<div class="tdc-gradient-result"><div class="tdc-gradient-color tdc-gradient-left-color"></div><div class="tdc-gradient-color tdc-gradient-right-color"></div></div>').prependTo(q);f('<div class="tdc-gradient-degree-label">deg.</div><input class="tdc-gradient-degree" placeholder="0">').appendTo(k.find(".wp-picker-input-wrap"));f('<div class="tdc-gradient-result-labels"><div class="tdc-gradient-result-label">Solid color</div><div class="tdc-gradient-result-label tdc-gradient-result-percentage"></div><div class="tdc-gradient-result-label">Gradient</div></div>').prependTo(k);
f('<div class="tdc-gradient-save">Save Gradient</div>').appendTo(k);var t=f('<div class="tdc-gradient-presets">Gradient presets</div>').appendTo(k),v=f('<div class="tdc-gradient-values-wrapper"></div>').appendTo(k);v=f('<div class="tdc-gradient-values"></div>').appendTo(v);var u=f('<div class="tdc-gradient-color-values-wrapper"></div>').appendTo(k);u=f('<div class="tdc-gradient-color-values"></div>').appendTo(u);if("undefined"!==typeof d.tdcAdminSettings.tdcSavings.gradients&&d.tdcAdminSettings.tdcSavings.gradients.length)for(var r=
!1,w=d.tdcAdminSettings.tdcSavings.gradients.length-1;0<=w;w--){var A=d.tdcAdminSettings.tdcSavings.gradients[w];try{var x=JSON.parse(d.atob(A));"undefined"!==typeof x.css&&(r=!0,f('<div class="tdc-gradient-value" style="'+x.css+'" data-gradient="'+A+'"><div class="tdc-gradient-value-delete"></div></div>').appendTo(v))}catch(z){}}r||t.hide();a.$container=k;a.$gradientResult=q;g.slider({slide:function(a,d){a=parseFloat(d.value/100);c._color._alpha=a;b.tdGradientColorPicker("color",c._color.toString());
n.text(1>a?a:"")},create:function(){var d=parseFloat(m.alpha/100);n.text(1>d?d:"");p.css("background-color",m.value);k.on("click",".wp-picker-clear",function(){c._color._alpha=1;n.text("");g.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(e,!0):a.setColor(e)});k.on("click",".wp-picker-default",function(){var a=f.cs_ParseColorValue(b.data("default-color")),d=parseFloat(a.alpha/100);c._color._alpha=d;n.text(1>d?d:"");g.slider("option","value",a.alpha).trigger("slide")});
k.on("click",".wp-color-result",function(a){l.toggle()});f("body").on("click.wpcolorpicker",function(){l.hide()});k.on("change keyup",".tdc-gradient-degree",function(b){b=f(this);a.degree=b.val().trim();a.mixedColors=a._getMixedColors();a._updateGradient();a._saveValue()})},value:m.alpha,step:1,min:0,max:100});if("undefined"!==typeof d.tdcAdminSettings.tdcSavings.recentColors&&d.tdcAdminSettings.tdcSavings.recentColors.length)for(w=d.tdcAdminSettings.tdcSavings.recentColors.length-1;0<=w;w--){r=d.tdcAdminSettings.tdcSavings.recentColors[w];
...
f.cs_ParseColorValue(b.val());b.tdPaletteColorPicker({clear:function(){b.trigger("keyup")},change:function(c,d){c=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",c);b.val(c).trigger("change");a.triggerSelection?a.setColor(c,!0):a.setColor(c)},create:function(){var c=b.data("a8cIris"),k=b.closest(".wp-picker-container"),l=f('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(k.find(".wp-picker-holder")),
g=l.find(".cs-alpha-slider"),n=l.find(".cs-alpha-text"),p=l.find(".cs-alpha-slider-offset"),q=f('<div class="tdc-color-values"></div>').appendTo(k.find(".wp-picker-holder"));a.$container=k;if("undefined"!==typeof d.tdcAdminSettings.tdcSavings.recentColors&&d.tdcAdminSettings.tdcSavings.recentColors.length)for(var t=d.tdcAdminSettings.tdcSavings.recentColors.length-1;0<=t;t--){var v=d.tdcAdminSettings.tdcSavings.recentColors[t];try{var u=JSON.parse(d.atob(v));"undefined"!==typeof u&&f('<div class="tdc-color-value" style="background-color: '+
u+'" data-color="'+u+'"><div class="tdc-color-value-delete"></div></div>').appendTo(q)}catch(r){}}g.slider({slide:function(a,d){a=parseFloat(d.value/100);c._color._alpha=a;b.tdPaletteColorPicker("color",c._color.toString());n.text(1>a?a:"")},create:function(){var d=parseFloat(m.alpha/100);n.text(1>d?d:"");p.css("background-color",m.value);k.on("click",".wp-picker-clear",function(){c._color._alpha=1;n.text("");g.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(e,!0):a.setColor(e)});
k.on("click",".wp-picker-default",function(){var a=f.cs_ParseColorValue(b.data("default-color")),d=parseFloat(a.alpha/100);c._color._alpha=d;n.text(1>d?d:"");g.slider("option","value",a.alpha).trigger("slide")});k.on("click",".wp-color-result",function(a){l.toggle()});f("body").on("click.wpcolorpicker",function(){l.hide()})},value:m.alpha,step:1,min:0,max:100})}})}else b.tdPaletteColorPicker({clear:function(){b.trigger("keyup")},change:function(a,c){b.val(c.color.toString()).trigger("change")}});
