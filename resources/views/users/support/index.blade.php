											...
											<ul class="list-group list-group-flush">
												<li class="list-group-item mb-2" href="#">
													<div class="span-icon pr-4">
														...
														<span class="notification pl-1">{{count($inboxCount)}}</span>
													</div>
													<b>Inbox Message</b>
												</li>
												...
												<li class="list-group-item" href="#">
													<div class="span-icon pr-4">
														...
														<span class="notification pl-1">{{count($sentCount)}}</span>
													</div>
													<b>Sent Message</b>
												</li>
											</ul>
											...
											<thead>
												...
												@foreach ($supports as $support)
													<tr>
														...
														<td>{{ date("j/ n/ Y", strtotime($support['created_at']))}}</td>
														<td>
